...
<div id="content" class="container col-md-12">
		...
		if(isset($_POST['btnAdd'])){
			...
			*/
			...
			/*if(!empty($category_name) && empty($error['category_image'])){*/
				...
				$sql_query = "INSERT INTO doa (judul,isi)
						VALUES(?, ?)";
				...
				if($result){
					$error['add_doa'] = " <h4><div class='alert alert-success'>
														* Success add new doa
														<a href='doa.php'>
					...
					$error['add_doa'] = " <span class='label label-danger'>Failed add doa</span>";
				}
			}
	...
	<div class="col-md-12">
		<h1>Add Doa</h1>
		<?php echo isset($error['add_doa']) ? $error['add_doa'] : '';?>
		<hr />
	</div>
	...
	<div class="col-md-12">
		<form method="post"
			...
			<label>Judul Do'a :</label><?php echo isset($error['judul']) ? $error['judul'] : '';?>
			<input type="text" class="form-control" name="judul"/>
			<br/>

			<label>Do'a :</label><?php echo isset($error['isi']) ? $error['isi'] : '';?>
			<textarea name="isi" id="isi" class="form-control" rows="50"></textarea>
