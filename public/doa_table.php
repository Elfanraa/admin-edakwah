...
<div id="content" class="container col-md-12">
	<?php 
		...
		if($stmt_paging ->prepare($sql_query)) {
			...
			$stmt_paging->bind_result($data['id_doa'], 
					$data['judul'],
					$data['isi']
					);
			// for paging purpose
	...
	<div class="col-md-12">
		<h1>
			Daftar Doa
			<a href="add-doa.php">
				<button class="btn btn-danger">Add Doa</button>
			</a>
		</h1>
		<hr/>
	</div>
	...
	<?php while ($stmt_paging->fetch()){ ?>
		<tr>
			...
			<td width="25%">
				...
				<a href="delete-doa.php?id=<?php echo $data['id_doa'];?>">
				Delete
				</a>
			</td>
		</tr>
	...
	<?php 
		...
		$function->doPages($offset, 'doa.php', '', $total_records, $keyword);?>
	</h4>
	</div>
